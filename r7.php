...
$sql = "SELECT * FROM entry1 WHERE  Department= 'Electronics and Telecommunication Engineering';";
...
$sql = "SELECT * FROM entry2 WHERE  Department= 'Electronics and Telecommunication Engineering';";
$result = mysqli_query($conn,$sql);
$resultCheck = mysqli_num_rows($result);
