...
$sql = "SELECT * FROM entry1 WHERE  Department= 'Mechanical Engineering';";
...
$sql = "SELECT * FROM entry2 WHERE  Department= 'Mechanical Engineering';";
$result = mysqli_query($conn,$sql);
$resultCheck = mysqli_num_rows($result);
